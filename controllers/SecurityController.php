...
class SecurityController extends BaseSecurityController
{
    ...
    public function actionLogin()
    {
	    ...
	    $managerUrl = '/order/index';
	    $accountantUrl = '/client/index';
	    $userUrl = '/order/index';
        /** @var LoginForm $model */
        ...
        if ($model->load(Yii::$app->getRequest()->post()) && $model->login()) {
            ...
            if(Yii::$app->user->identity->role_id == User::LEGAL_ENTITY || Yii::$app->user->identity->role_id == User::INDIVIDUAL)
            {
	        ...
	        {
		        return $this->redirect($accountantUrl);
	        }
	        elseif(Yii::$app->user->identity->role_id == User::ROLE_MANAGER)
	        {
		        return $this->redirect(Url::toRoute($managerUrl));
	        }
