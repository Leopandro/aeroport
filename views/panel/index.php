...
//		        'format' => 'raw',
		        ...
		        'value' => function($model)
		        {
			        ...
			        else $result = \app\models\CarTariff::findOne(['id' => $model->car_id])->town_center;
			        if (!$result)
				        $result = '-';
			        return $result;
		        }
	        ...
	        [
		        ...
		        'value' => function($model)
		        {
			        if ($model->use_new_tariffs)
				        $result =  $model->town;
			        else $result = \app\models\CarTariff::findOne(['id' => $model->car_id])->town;
			        if (!$result)
				        $result = '-';
			        return $result;
		        }
	        ...
	        [
		        ...
		        'value' => function($model)
		        {
			        ...
			        else $result = \app\models\CarTariff::findOne(['id' => $model->car_id])->km_price;
			        if (!$result)
				        return $result = '-';
			        return $result;
		        }
